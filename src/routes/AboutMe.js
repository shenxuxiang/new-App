...
export default class About extends PureComponent {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      mobile: props.navigation.state.params.userMobile,
      userInfo: {
        userName: '',
        sex: '',
        userMobile: '',
  ...
  componentDidMount() {
    this.props.getUserInfo({ userMobile: this.state.mobile })
      ...
      <View style={styles.container}>
        <Animated.View
          style={[
            ...
            {
              opacity: this.state.distY.interpolate({
        ...
        <ScrollView
          ...
          onScroll={
            Animated.event([{
              nativeEvent: {
                contentOffset: { y: this.state.distY },
              },
            }])
          }
        >
